...
export function S02_MarketShift({ index, total }: { index: number; total: number }) {
  return (
    ...
    >
      <div className="grid h-full grid-cols-[1.05fr_0.95fr] gap-14 pt-2">
        <ul className="flex flex-col justify-center gap-6">
          ...
          <Bullet title="Legacy solutions are being left behind:">
            ...
            alternative-data and insight platforms, leaving traditional providers with
            shrinking relevance and lower demand.
          </Bullet>
        </ul>
