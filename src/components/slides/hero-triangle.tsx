    ...
    <div className="relative mx-auto" style={{ width: SIZE, height: SIZE, maxWidth: "100%" }} aria-hidden>
      ...
      {NODES.map((label, i) => (
        <div
          ...
          className="pointer-events-none absolute top-0 left-0 whitespace-nowrap rounded-full border border-[rgba(58,154,83,0.35)] bg-white/90 px-2.5 py-1 text-[11.5px] font-semibold text-gradient shadow-sm backdrop-blur-sm will-change-transform"
        >
          {label}
        </div>
      ))}
